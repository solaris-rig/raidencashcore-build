...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'raidencashcore-' + name : 'raidencashcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/raidencashcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external raidencashcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:raidencashcore-lib -o raidencashcore-lib.js';
    }
